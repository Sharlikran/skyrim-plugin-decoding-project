...
const
  ...
  PFDX : TwbSignature = 'PFDX'; { New To Fallout 76 1.7.17.9}
  PFDZ : TwbSignature = 'PFDZ'; { New To Fallout 76 1.7.17.9}
  ...
  PLYT : TwbSignature = 'PLYT'; { New To Fallout 76 1.7.17.9}
  ...
  PTPR : TwbSignature = 'PTPR'; { New To Fallout 76 1.7.17.9}
  PTSU : TwbSignature = 'PTSU'; { New To Fallout 76 1.7.17.9}
  PTDS : TwbSignature = 'PTDS'; { New To Fallout 76 1.7.17.9}
 ...
 &TYPE : TwbSignature = 'TYPE'; { New To Starfield }
  ...
  WSAM : TwbSignature = 'WSAM'; { New To Fallout 76 1.7.17.9 }
  ...
  WTDA : TwbSignature = 'WTDA'; { New To Fallout 76 1.7.17.9 }
  WTDS : TwbSignature = 'WTDS'; { New To Fallout 76 1.7.17.9 }
  WTDT : TwbSignature = 'WTDT'; { New To Fallout 76 1.7.17.9 }
  ...
  XRLL : TwbSignature = 'XRLL'; { New To Fallout 76 1.7.17.9}
  XRL2 : TwbSignature = 'XRL2'; { New To Fallout 76 1.7.17.9}
